...
net = Net(ID = 'net', optimizer_details = optimizer_details)
net.add_nodes(matmul1, [x], z1)
net.add_nodes(AF1, [z1], a1)
net.add_nodes(Drop1, [a1], a1_drop)
net.add_nodes(matmul2, [a1_drop], z2)
net.add_nodes(AF2, [z2], a2)
net.add_nodes(Drop2, [a2], a2_drop)
net.add_nodes(matmul3, [a2_drop], z3)
